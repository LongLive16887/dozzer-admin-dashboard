...
export const Item = ({
    ...
    return(
        <TableRow key={item.id}>
                ...
                <TableCell>{selectedLanguage === "uz" ? item.name_uz : item.name_ru ?? "No Data"}</TableCell>
                <TableCell>{selectedLanguage === "uz" ? item.short_info_uz : item.short_info_ru ?? "No Data"}</TableCell>
                <TableCell>
