...
export const ViewItem = ({ itemId }: { itemId: string }) => {
  ...
  return (
    <Dialog open={showModal} onOpenChange={setShowModal}>
      ...
      <DialogContent className="sm:max-w-[600px] sm:max-h-[700px] overflow-scroll p-6 rounded-lg shadow-xl bg-white dark:bg-gray-900">
        <DialogHeader>
          <LanguageSelector />
          <DialogTitle className="text-xl font-bold text-gray-800 dark:text-white jus">Item Details</DialogTitle>
        ...
        <div className="grid gap-4 py-4 text-gray-800 dark:text-white">
          ...
          <div className="space-y-1">
            ...
            <img src={result.image} alt="Main" className="w-full h-auto rounded-md shadow-md" />
          </div>
