...
export const CreateItem = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    short_info_ru: "",
    image: "",
    vizov_price: null as number | null,
    smenu_price: null as number | null,
    smenu_duration: null as number | null,
    hourly_price: null as number | null,
    begin_date: "",
    description_uz: "",
    description_ru: "",
    base_id: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const itemData = {
      ...
      photos: [],
      vizov_price: formData.vizov_price ?? 0,
      smenu_price: formData.smenu_price ?? 0,
      smenu_duration: formData.smenu_duration ?? 0,
      hourly_price: formData.hourly_price ?? 0,
    };
