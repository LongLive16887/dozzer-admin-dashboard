...
import { useGetBaseByIdQuery, useUpdateBaseMutation } from "@/shared/api/base";

export const UpdateBase = ({ baseId }: { baseId: string }) => {
  const { data: baseData, isLoading: isFetching } = useGetBaseByIdQuery(baseId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateBase({ id: baseId, base: updatedBase }).unwrap();
