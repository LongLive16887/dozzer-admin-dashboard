...
import { ICategoryUpdate } from "../model";

interface UpdateCategoryProps {
  updateCategoryData: ICategoryUpdate;
}
...
export const UpdateCategory = ({ updateCategoryData }: UpdateCategoryProps) => {
  ...
  const [imgUrl, setImageUrl] = useState(updateCategoryData.img_url || "");
      ...
      <DialogContent className="sm:max-w-[425px] sm:max-h-[550px] overflow-scroll">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="imgUrl" className="text-center">
                Image URL
              </Label>
              <Input
                id="imgUrl"
