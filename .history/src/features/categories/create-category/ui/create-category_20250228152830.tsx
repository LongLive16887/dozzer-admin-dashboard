...
import { useCreateCategoryMutation } from "@/shared/api-api";
...
export const CreateFeedCategory = () => {
  ...
  return (
    <Dialog open={showModal} onOpenChange={setShowModal}>
      ...
      <DialogContent className="sm:max-w-[425px] sm:max-h-[550px] overflow-scroll">
        <DialogHeader>
          <DialogTitle>Add New Feed Category</DialogTitle>
          <DialogDescription>
            Fill out the form to add a new Feed Category to the system
          </DialogDescription>
        </DialogHeader>
