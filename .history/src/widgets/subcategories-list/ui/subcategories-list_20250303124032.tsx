    ...
    <div className="flex flex-1 flex-col gap-4 p-4">
      <div className="rounded-xl bg-muted/50 p-4">
        <Table>
          ...
          <TableBody>
  {Array.isArray(dataCategories?.data?.results) && dataCategories.data.results.length > 0 ? (
    ...
    <tr>
      <td colSpan={3} className="text-center p-4">
        <div className="flex flex-1 flex-col items-center justify-center h-full p-4">
          <div className="text-center rounded-xl bg-muted/50 p-6">
            <p className="text-lg font-semibold">⚠ No subcategories found. Please select a subcategory in the categories page.</p>
            <Link to="/categories" className="text-blue-500 underline mt-2 inline-block">
              Go to Categories Page
            </Link>
          </div>
