...
export const SubCategoriesList = () => {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4">
      <h1 className="p-3 bg-gray-100 dark:bg-gray-800 rounded-md "><span className="text-blue-500">NAME:</span> {categoryName} <span className="text-blue-500">ID:</span> {categoryId}</h1>
      <div className="rounded-xl bg-muted/50 p-4">
        <Table>
          <TableHeader>
            <TableRow>
